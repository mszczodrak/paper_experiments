...
for snapshot_id in N:
	...
	all_max.append(snapshot['max_number_of_good_neighbors'])
	all_min.append(snapshot['min_number_of_good_neighbors'])
	all_std.append(snapshot['std_number_of_good_neighbors'])
	all_avg.append(snapshot['avg_number_of_good_neighbors'])
...
ax.set_ylabel('Number of Good Neighbors')
