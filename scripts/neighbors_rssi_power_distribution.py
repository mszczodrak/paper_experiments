...
if len(sys.argv) != 7:
	print "usage %s <data_to_import> <testbed_conf> <rssi_threshold> <m> <n> <init_power>\n" % (sys.argv[0])
	exit()
...
default_tx = int(float(sys.argv[6]))
...
fout.write("/* Trace generated by Neighborhood M=%d N=%d RSSI=-%d */\n\n" % (m, n, rssi_threshold))
