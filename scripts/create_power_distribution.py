...
if len(sys.argv) != 8:
	print "usage %s <data_to_import> <testbed_conf> <etx_threshold> <m> <n> <init_power> <time>\n" % (sys.argv[0])
	exit()
...
fout.write("/* Trace generated by Neighborhood M=%d N=%d ETX=%d %s */\n\n" % (m, n, etx_threshold, day_time))
